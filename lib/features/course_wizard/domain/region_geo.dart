...
///
/// 랜덤 지역 선택 지도에 칩을 놓을 때 **서버가 좌표를 안 줄 경우의 폴백**이다.
/// 추천·목록 응답은 `lat`·`lng`를 싣고(core #405) 그 값이 이 표보다 우선한다
/// — 이 표는 옛 서버·목 데이터에서만 쓰인다. 시도 약칭([sido])은 착지 면
/// (`SidoShapes`)의 키로도 쓰이므로 좌표가 와도 이름 찾기는 계속 한다.
///
